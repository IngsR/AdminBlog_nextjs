...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col relative overflow-hidden bg-grid">
      ...
      <div className="absolute bottom-[-20%] left-[-10%] w-[60%] h-[60%] bg-violet-600/10 rounded-full blur-[160px] animate-pulse" style={{ animationDelay: '3s' }}></div>

      {/* Hero Section */}
      <main className="flex-1 flex flex-col items-center justify-center p-8 relative z-10">
        <div className="max-w-4xl text-center space-y-12">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs font-bold text-indigo-400 uppercase tracking-widest animate-in fade-in slide-in-from-top-4 duration-500">
            <Sparkles size={14} className="animate-pulse" />
            Empowering Modern Bloggers
          </div>
          ...
          <div className="space-y-6 animate-in fade-in zoom-in duration-700">
            ...
            <p className="text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed">
              AdminBLog is a premium management portal built for velocity. 
              Powered by Next.js, Supabase, and Drizzle ORM for ultimate control.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-6 duration-1000">
            <Link href="/login">
              <Button size="lg" variant="premium" className="h-16 px-10 rounded-2xl text-lg font-black group transition-all duration-500">
                Enter Admin Portal
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full mt-32 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300">
          <div className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:bg-white/10 hover:-translate-y-2 transition-all duration-500 group">
            ...
            <h3 className="text-xl font-bold mb-3">Vitesse Engine</h3>
            <p className="text-zinc-500">Supercharged CRUD operations with Drizzle ORM and Postgres performance.</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:bg-white/10 hover:-translate-y-2 transition-all duration-500 group">
            ...
            <p className="text-zinc-500">Beautiful, reusable, and accessible design system built from the ground up.</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:bg-white/10 hover:-translate-y-2 transition-all duration-500 group">
            ...
            <p className="text-zinc-500">Military-grade session security with iron-session and bcrypt hashing.</p>
          </div>
        </div>
      </main>
      ...
      <footer className="p-8 text-center text-zinc-600 text-sm font-medium relative z-10">
        &copy; {new Date().getFullYear()} AdminBLog Premium Portal. All rights reserved.
      </footer>
    </div>
  );
}
